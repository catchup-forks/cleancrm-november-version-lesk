      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a class="btn btn-default btn-sm" href="{!! route('admin.roles.create') !!}"
             title="{{ trans('admin/roles/general.button.create') }}">
                ...
                <tr>
                  ...
                  <td>
                    @if ( $role->isEditable() || $role->canChangePermissions() )
                      <a href="{!! route('admin.roles.edit', $role->id) !!}" title="{{ trans('general.button.edit') }}"><i
                          class="fa fa-pencil-square-o"></i></a>
                    @else
                      <i class="fa fa-pencil-square-o text-muted"
                         title="{{ trans('admin/roles/general.error.cant-edit-this-role') }}"></i>
                    @endif
                    ...
                    @if ( $role->isDeletable() )
                      <a href="{!! route('admin.roles.confirm-delete', $role->id) !!}" data-toggle="modal"
                    ...
                    @else
                      <i class="fa fa-trash-o text-muted"
                         title="{{ trans('admin/roles/general.error.cant-delete-this-role') }}"></i>
                    @endif
                  </td>
                </tr>
              @endforeach
