    ...
    <div class='col-md-12'>
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          &nbsp;
          <a class="btn btn-default btn-sm" href="{!! route('admin.settings.create') !!}"
             title="{{ trans('admin/settings/general.action.create') }}">
            <i class="fa fa-plus-square"></i>
          </a>
          &nbsp;
          <a class="btn btn-default btn-sm" href="{!! route('admin.settings.load') !!}"
             title="{{ trans('admin/settings/general.action.load') }}">
            ...
            <table class="table table-hover">
              ...
              @foreach($settingsFiltered as $key => $value)
                <tr>
                  ...
                  <td>
                    <a href="{!! route('admin.settings.edit', $key) !!}" title="{{ trans('general.button.edit') }}"><i
                        class="fa fa-pencil-square-o"></i></a>
                    <a href="{!! route('admin.settings.confirm-delete', $key) !!}" data-toggle="modal"
