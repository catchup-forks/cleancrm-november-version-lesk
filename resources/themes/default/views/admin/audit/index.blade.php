    ...
    <div class='col-md-12'>
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          &nbsp;
          <a class="btn btn-default btn-sm" href="{!! route('admin.audit.purge') !!}"
             title="{{ trans('admin/audit/general.button.purge', ['purge_retention' => $purge_retention]) }}">
                ...
                <tr>
                  ...
                  <td>
                    <a href="{!! route('admin.audit.show', $audit->id) !!}"
                       title="{{ trans('general.button.display') }}"><i id="action-show" class="fa fa-eye"></i></a>
                    @if ( $audit->replay_route )
                      <a href="{!! route('admin.audit.replay', $audit->id) !!}"
                         title="{{ trans('general.button.replay') }}"><i id="replay"
                                                                         class="fa fa-refresh spin-on-hover"></i></a>
                    @endif
                  </td>
                </tr>
              @endforeach
