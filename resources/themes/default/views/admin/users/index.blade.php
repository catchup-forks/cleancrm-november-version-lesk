      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <a class="btn btn-default btn-sm" href="{!! route('admin.users.create') !!}"
             title="{{ trans('admin/users/general.button.create') }}">
            ...
            <table class="table table-hover">
              ...
              @foreach($users as $user)
                <tr>
                  ...
                  <td>
                    <a href="{!! route('admin.users.edit', $user->id) !!}" title="{{ trans('general.button.edit') }}"><i
                        class="fa fa-pencil-square-o"></i></a>

                    @if ($user->canBeDisabled())
                      @if ( $user->enabled )
                        <a href="{!! route('admin.users.disable', $user->id) !!}"
                    ...
                    @else
                      <i class="fa fa-ban text-muted"
                         title="{{ trans('admin/users/general.error.cant-be-disabled') }}"></i>
                    @endif
                    ...
                    @else
                      <i class="fa fa-trash-o text-muted"
                         title="{{ trans('admin/users/general.error.cant-be-deleted') }}"></i>
                    @endif
                  </td>
                </tr>
              @endforeach
