...
<div class="nav-tabs-custom">
  <ul class="nav nav-tabs">
    ...
    <li class=""><a href="#tab_routes" data-toggle="tab" aria-expanded="false">{!! trans('general.tabs.routes') !!}</a>
    </li>
    <li class=""><a href="#tab_roles" data-toggle="tab" aria-expanded="false">{!! trans('general.tabs.roles') !!}</a>
    </li>
  </ul>
          ...
          <table class="table table-hover" id="tbl-roles">
            ...
            @foreach($perm->roles as $role)
              <tr>
                ...
                <td style="text-align: right">
                  <a class="btn-remove-role" href="#" title="{{ trans('general.button.remove-role') }}"><i
                      class="fa fa-trash-o deletable"></i></a>
                </td>
              </tr>
            @endforeach
